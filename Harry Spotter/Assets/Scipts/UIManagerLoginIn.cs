    ...
    */
    ...
    public void OnSignUpSubmmitButton()
    {
        ...
        else
        {
            if(_signUpEmailInputText.text.Length > 4 && _signUpPassInputText.text.Length >= 6)
            {
                ...
                StartCoroutine(_loginNetwork.PostUserAccount("https://harryspotter.eu.ngrok.io/signup", newUser.ToJsonString(), SignUpGetUserID));
            }
    ...
    public void OnLogInSubmmitButton()
    {
       // UserAccount newUser = new UserAccount(_loginEmailInputText.text, _loginPassInputText.text);
        ...
        else
        {
            ...
            {
                UserAccount newUser = new UserAccount(_loginEmailInputText.text, _loginPassInputText.text);
                StartCoroutine(_loginNetwork.PostUserAccount("https://harryspotter.eu.ngrok.io/signin", newUser.ToJsonString(), LoginGetUserID));
            }
    ...
    public void LoginGetUserID(string userID)
    {
        ...
        } else
        {
            ...
            StartCoroutine(_loginNetwork.PostUserInfo("https://harryspotter.eu.ngrok.io/getUser", _userId.Serialize().ToString(),GetUserAccountDetail));
        }
    }
